...
vehicles = Category.create(name: "vehicles", link: "vehicles", position: 0, additional_filtertext: "cars", parent: order)
...
meals = Category.create(name: "meals", link: "meals", position: 0, additional_filtertext: "snacks", parent: health)
