Category.create!([
  ...
  {id: 21, name: "credit_cards", link: "credit_cards", position: 0, parent_id: 1, additional_filtertext: nil, icon: "famfamfam/creditcards.png", explicit: nil, user_type_mask: nil, experimental: nil, simple: nil},
  ...
  {id: 65, name: "books", link: "books", position: 0, parent_id: 2, additional_filtertext: nil, icon: "FatCow_Icons16x16/book.png", explicit: nil, user_type_mask: nil, experimental: nil, simple: nil},
  ...
  {id: 8, name: "contacts", link: "contacts", position: 0, parent_id: 1, additional_filtertext: nil, icon: "famfamfam/user.png", explicit: nil, user_type_mask: nil, experimental: nil, simple: nil},
  ...
  {id: 62, name: "camp_locations", link: "camp_locations", position: 0, parent_id: 2, additional_filtertext: nil, icon: "FatCow_Icons16x16/tree.png", explicit: nil, user_type_mask: nil, experimental: nil, simple: nil},
  ...
  {id: 14, name: "apartments", link: "apartments", position: 0, parent_id: 1, additional_filtertext: nil, icon: "famfamfam/house.png", explicit: nil, user_type_mask: nil, experimental: nil, simple: nil},
  ...
  {id: 29, name: "health", link: "health", position: 0, parent_id: 1, additional_filtertext: nil, icon: "FatCow_Icons16x16/health.png", explicit: nil, user_type_mask: nil, experimental: nil, simple: nil},
  ...
  {id: 9, name: "files", link: "files", position: 0, parent_id: 1, additional_filtertext: "pictures", icon: "famfamfam/attach.png", explicit: nil, user_type_mask: nil, experimental: nil, simple: nil},
  ...
  {id: 75, name: "users", link: "users", position: 0, parent_id: 1, additional_filtertext: nil, icon: "famfamfam/group.png", explicit: nil, user_type_mask: nil, experimental: nil, simple: nil},
  ...
  {id: 56, name: "promotions", link: "promotions", position: 0, parent_id: 51, additional_filtertext: "coupons gifts vouchers credits", icon: "FatCow_Icons16x16/coins_in_hand.png", explicit: nil, user_type_mask: nil, experimental: nil, simple: nil},
  ...
  {id: 107, name: "obscure", link: "obscure", position: 0, parent_id: 1, additional_filtertext: nil, icon: "FatCow_Icons16x16/donut.png", explicit: nil, user_type_mask: nil, experimental: nil, simple: nil},
  ...
  {id: 157, name: "business_cards", link: "business_cards", position: 0, parent_id: 1, additional_filtertext: nil, icon: "FatCow_Icons16x16/vcard.png", explicit: nil, user_type_mask: nil, experimental: nil, simple: nil},
  {id: 158, name: "problem_reports", link: "problem_reports", position: 0, parent_id: 1, additional_filtertext: "complaint concern incident observation warning feedback suggestion bug issue", icon: "FatCow_Icons16x16/exclamation.png", explicit: nil, user_type_mask: nil, experimental: nil, simple: nil},
  {id: 159, name: "connections", link: "connections", position: 0, parent_id: 3, additional_filtertext: "friends relationships", icon: "FatCow_Icons16x16/users_men_women.png", explicit: nil, user_type_mask: nil, experimental: nil, simple: nil},
  {id: 163, name: "myreferences", link: "myreferences", position: 0, parent_id: 1, additional_filtertext: nil, icon: "FatCow_Icons16x16/client_account_template.png", explicit: nil, user_type_mask: nil, experimental: nil, simple: nil}
])
