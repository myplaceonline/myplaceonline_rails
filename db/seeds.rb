Category.create!([
  ...
  {id: 236, name: "humane_locations", link: "find_humane/humane_locations", position: 0, parent_id: 1, additional_filtertext: nil, icon: "FatCow_Icons16x16/map.png", explicit: nil, user_type_mask: 1, experimental: nil, simple: nil, internal: nil},
  {id: 237, name: "humane_products", link: "find_humane/humane_products", position: 0, parent_id: 1, additional_filtertext: nil, icon: "FatCow_Icons16x16/steak_meat.png", explicit: nil, user_type_mask: 1, experimental: nil, simple: nil, internal: nil},
  {id: 238, name: "ads", link: "find_humane/ads", position: 0, parent_id: 1, additional_filtertext: nil, icon: "FatCow_Icons16x16/billboard_picture.png", explicit: nil, user_type_mask: 1, experimental: nil, simple: nil, internal: nil},
  {id: 239, name: "humane_deliveries", link: "find_humane/humane_deliveries", position: 0, parent_id: 1, additional_filtertext: nil, icon: "FatCow_Icons16x16/package.png", explicit: nil, user_type_mask: 1, experimental: nil, simple: nil, internal: nil},
  {id: 240, name: "producers", link: "find_humane/producers", position: 0, parent_id: 1, additional_filtertext: nil, icon: "FatCow_Icons16x16/user_cowboy.png", explicit: nil, user_type_mask: 1, experimental: nil, simple: nil, internal: nil},
  {id: 241, name: "whatdidiwearthens", link: "whatdidiwearthens", position: 0, parent_id: 1, additional_filtertext: nil, icon: "FatCow_Icons16x16/shirt_polo.png", explicit: nil, user_type_mask: nil, experimental: nil, simple: nil, internal: nil},
  {id: 242, name: "wearables", link: "wearables", position: 0, parent_id: 1, additional_filtertext: nil, icon: "FatCow_Icons16x16/shirt_polo.png", explicit: nil, user_type_mask: nil, experimental: nil, simple: nil, internal: nil},
  {id: 243, name: "maintenance_iterations", link: "find_humane/maintenance_iterations", position: 0, parent_id: 1, additional_filtertext: nil, icon: "FatCow_Icons16x16/construction.png", explicit: nil, user_type_mask: 1, experimental: nil, simple: nil, internal: nil},
  {id: 244, name: "maintenances", link: "find_humane/maintenances", position: 0, parent_id: 1, additional_filtertext: nil, icon: "FatCow_Icons16x16/construction.png", explicit: nil, user_type_mask: 1, experimental: nil, simple: nil, internal: nil},
  {id: 245, name: "subscriptions", link: "find_humane/subscriptions", position: 0, parent_id: 1, additional_filtertext: nil, icon: "FatCow_Icons16x16/construction.png", explicit: nil, user_type_mask: 1, experimental: nil, simple: nil, internal: nil},
  {id: 246, name: "communities", link: "rabbl/communities", position: 0, parent_id: 1, additional_filtertext: nil, icon: "FatCow_Icons16x16/construction.png", explicit: nil, user_type_mask: 1, experimental: nil, simple: nil, internal: nil},
  {id: 248, name: "apikeys", link: "find_humane/apikeys", position: 0, parent_id: 1, additional_filtertext: nil, icon: "FatCow_Icons16x16/construction.png", explicit: nil, user_type_mask: 1, experimental: nil, simple: nil, internal: nil}
])
