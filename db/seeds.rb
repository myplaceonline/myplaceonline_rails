Category.create!([
  ...
  {id: 239, name: "videos", link: "videos", position: 0, parent_id: 2, additional_filtertext: nil, icon: "FatCow_Icons16x16/video.png", explicit: nil, user_type_mask: nil, experimental: nil, simple: nil, internal: nil}
])
