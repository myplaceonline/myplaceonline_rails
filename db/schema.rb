...
ActiveRecord::Schema.define(version: 20180220202437) do
  ...
  add_foreign_key "food_nutrition_information_amounts", "food_nutrition_informations", name: "food_nutrition_information_amounts_food_nutrition_information_i"
