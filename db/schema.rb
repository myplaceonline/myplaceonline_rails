...
ActiveRecord::Schema.define(version: 20151229062104) do
  ...
  add_index "permissions", ["contact_id"], name: "index_permissions_on_contact_id", using: :btree
  ...
  add_foreign_key "permissions", "contacts"
