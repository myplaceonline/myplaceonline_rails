...
ActiveRecord::Schema.define(version: 2026_08_12_033946) do
  ...
  create_table "barbecues", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["identity_id"], name: "index_barbecues_on_identity_id"
    t.index ["location_id"], name: "index_barbecues_on_location_id"
  end
  ...
  create_table "find_humane_ads", force: :cascade do |t|
    t.string "name"
    t.string "img"
    t.string "link"
    t.integer "visit_count"
  ...
  create_table "find_humane_humane_deliveries", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["find_humane_humane_location_id"], name: "fhhd_fhhl"
    t.index ["identity_id"], name: "index_find_humane_humane_deliveries_on_identity_id"
  end
  ...
  create_table "find_humane_humane_locations", force: :cascade do |t|
    ...
    t.boolean "school"
    t.string "certificationsite1"
    t.string "certificationsite2"
    t.boolean "nonprofit"
    t.boolean "weddings"
    t.boolean "butcher"
    t.boolean "generalstore"
    t.boolean "farm_list_farm"
    t.boolean "farm_list_farm_store"
    t.string "contact1_name"
    t.string "contact1_role"
    t.string "contact1_email"
    t.string "contact1_phone"
    t.text "contact1_notes"
    t.string "contact2_name"
    t.string "contact2_role"
    t.string "contact2_email"
    t.string "contact2_phone"
    t.text "contact2_notes"
  ...
  create_table "find_humane_humane_products", force: :cascade do |t|
    ...
    t.boolean "noantibiotics"
    t.boolean "zerocarbs"
    t.boolean "microwavable"
    t.boolean "fullycooked"
    t.boolean "frozen"
    t.boolean "pastureraised"
    t.boolean "grassfed"
    t.boolean "grassfinished"
    t.string "producer"
    t.boolean "vegetariandiet"
    t.boolean "nocasein"
    t.boolean "glutenfree"
    t.boolean "nonitrates"
    t.boolean "nosoy"
    t.boolean "freerange"
    t.boolean "beef"
    t.boolean "chicken"
    ...
    t.boolean "organic"
    t.boolean "nopesticides"
    t.boolean "smallfamilyfarms"
    t.boolean "cagefree"
    t.boolean "restorativefarms"
    t.boolean "bcorporation"
    t.text "internalnotes"
    t.boolean "partiallyhumane"
    t.boolean "ketofriendly"
    t.boolean "paleofriendly"
    t.boolean "dairyfree"
    t.boolean "nongmo"
    t.boolean "american_humane_certified"
    t.boolean "american_grassfed_association"
    ...
    t.integer "cornucopia_institute_score"
    t.integer "cornucopia_institute_score_type"
    t.integer "cornucopia_institute_rating"
    t.boolean "certified_paleo"
    t.boolean "keto_certified"
    t.boolean "halal"
    t.boolean "certified_humane_grass_fed"
    t.boolean "dogfood"
    t.boolean "catfood"
    t.boolean "clothing"
    t.boolean "regenerative_organic_certified"
    t.boolean "raw"
    t.boolean "dairygoat"
    ...
    t.boolean "group_best_first"
    t.boolean "group_best_second"
    t.boolean "group_best_third"
    t.boolean "verified"
    t.boolean "eggs_betterhatched"
    t.boolean "butter_cow"
    t.boolean "butter_goat"
    t.boolean "butter_sheep"
    t.boolean "yogurt_cow"
    t.boolean "yogurt_goat"
    t.boolean "yogurt_sheep"
    t.boolean "condiment"
    t.boolean "snack"
    t.boolean "broth"
    ...
    t.boolean "regenified_1"
    t.boolean "regenified_2"
    t.boolean "regenified_3"
  ...
  create_table "google_place_search_results", force: :cascade do |t|
    t.string "search"
    t.string "placeid"
    t.text "jsonresult"
    t.datetime "created_at", precision: 6, null: false
  ...
  create_table "life_change_files", force: :cascade do |t|
    t.bigint "life_change_id"
    t.bigint "identity_file_id"
    t.bigint "identity_id"
    t.integer "position"
    t.boolean "is_public"
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["identity_file_id"], name: "index_life_change_files_on_identity_file_id"
    t.index ["identity_id"], name: "index_life_change_files_on_identity_id"
    t.index ["life_change_id"], name: "index_life_change_files_on_life_change_id"
  end

  create_table "life_changes", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["identity_id"], name: "index_life_changes_on_identity_id"
  end
  ...
  create_table "rabbl_communities", force: :cascade do |t|
    ...
    t.integer "first_free_men"
    t.integer "first_free_women"
    t.boolean "inviteonly"
  ...
  create_table "rabbl_community_memberships", force: :cascade do |t|
  ...
  create_table "wager_ref_bets", force: :cascade do |t|
    t.string "key"
    t.string "title"
    t.text "stakes"
    t.text "winConditions"
    t.integer "status"
    t.bigint "identity_id", null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
  ...
  create_table "whatdidiwearthens", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["identity_id"], name: "index_whatdidiwearthens_on_identity_id"
  end
  ...
  add_foreign_key "barbecues", "identities"
  add_foreign_key "barbecues", "locations"
  ...
  add_foreign_key "life_change_files", "identities"
  add_foreign_key "life_change_files", "identity_files"
  add_foreign_key "life_change_files", "life_changes"
  add_foreign_key "life_changes", "identities"
