...
ActiveRecord::Schema.define(version: 2020_10_11_231625) do
  ...
  create_table "drom_match_dates", force: :cascade do |t|
    ...
    t.boolean "restaurantAll"
    t.boolean "restaurantCoffee"
    t.boolean "restaurantAmerican"
    t.boolean "restaurantItalian"
    t.boolean "restaurantSteakhouse"
    t.boolean "restaurantSeafood"
    t.boolean "restaurantMexican"
    t.boolean "restaurantJapanese"
    t.boolean "restaurantFusionEclectic"
    t.boolean "restaurantBarbecue"
    t.boolean "restaurantComfortFood"
    t.boolean "restaurantIrish"
    t.boolean "restaurantBurgers"
    t.boolean "restaurantRussian"
    t.boolean "restaurantBreakfast"
    t.boolean "restaurantDessert"
    t.boolean "restaurantFinecuts"
    t.boolean "restaurantWildGame"
    t.boolean "restaurantAsian"
    t.boolean "restaurantBarLoungeBottleService"
    t.boolean "restaurantBrewery"
    t.boolean "restaurantCalifornian"
    t.boolean "restaurantCocktailBar"
    t.boolean "restaurantContemporaryAsian"
    t.boolean "restaurantContemporaryFrenchAmerican"
    t.boolean "restaurantEuropean"
    t.boolean "restaurantFarmtotable"
    t.boolean "restaurantMediterranean"
    t.boolean "restaurantPizzaBar"
    t.boolean "restaurantSouthAmerican"
    t.boolean "restaurantWineBar"
    t.boolean "restaurantVegetarian"
    t.boolean "restaurantVegan"
    t.boolean "restaurantGlutenFreeOptions"
    t.boolean "restaurantSoyFreeOptions"
