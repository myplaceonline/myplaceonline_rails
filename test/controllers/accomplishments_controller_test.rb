...
class AccomplishmentsControllerTest < ActionController::TestCase
  ...
  test "should create accomplishment" do
    assert_difference('Accomplishment.count') do
      post :create, accomplishment: { accomplishment: @accomplishment.accomplishment, identity_id: @accomplishment.identity_id, name: @accomplishment.name }
    end
  ...
  test "should update accomplishment" do
    patch :update, id: @accomplishment, accomplishment: { accomplishment: @accomplishment.accomplishment, identity_id: @accomplishment.identity_id, name: @accomplishment.name }
    assert_redirected_to accomplishment_path(assigns(:accomplishment))
  end
