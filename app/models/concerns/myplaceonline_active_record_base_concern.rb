module MyplaceonlineActiveRecordBaseConcern
  ...
  class_methods do
    ...
    def child_file(parent:, class_name: nil, destroy_dependent: nil, required: true, parent_required: false)
      if class_name.nil?
        belongs_to parent, required: parent_required
      else
        belongs_to parent, class_name: class_name, required: parent_required
      end
