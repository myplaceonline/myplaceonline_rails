class Calendar < ApplicationRecord
  ...
  timespan_field :website_domain_registration_threshold
  ...
  def largest_threshold_seconds
    result = Calendar.max(
      ...
      WebsiteDomainRegistration::DEFAULT_WEBSITE_DOMAIN_REGISTRATION_THRESHOLD_SECONDS
    ).seconds
    ...
    if !website_domain_registration_threshold_seconds.nil? && website_domain_registration_threshold_seconds > result
      result = website_domain_registration_threshold_seconds.seconds
    end
    result
  end
