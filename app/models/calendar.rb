class Calendar < ActiveRecord::Base
  ...
  def largest_threshold_seconds
    result = Calendar.max(
      ...
      DueItem::DEFAULT_TRASH_PICKUP_THRESHOLD_SECONDS,
      DueItem::DEFAULT_PERIODIC_PAYMENT_BEFORE_THRESHOLD_SECONDS,
      DueItem::DEFAULT_PERIODIC_PAYMENT_AFTER_THRESHOLD_SECONDS,
