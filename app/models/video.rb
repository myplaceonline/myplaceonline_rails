class Video < ApplicationRecord
  ...
  def self.properties
    [
      { name: :video_name, type: ApplicationRecord::PROPERTY_TYPE_STRING },
      { name: :video_link, type: ApplicationRecord::PROPERTY_TYPE_STRING },
      ...
      { name: :video_files, type: ApplicationRecord::PROPERTY_TYPE_FILES },
    ]
  end
